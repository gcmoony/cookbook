...
function RecipeCard({recipe}) {
  ...
  >
    {recipe.imageLink ? 
    <img className="aspect-square min-w-full object-cover bg-slate-600 text-center rounded-xl "
      src={recipe.imageLink} 
      alt=" Recipe Picture" 
      /> :
      <div
      className="aspect-square min-w-full bg-slate-700 flex justify-center items-center rounded-xl ">
