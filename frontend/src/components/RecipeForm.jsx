  ...
  return (
    ...
    >
      <fieldset>
        ...
        <div className='bg-slate-900 p-2 rounded mb-5 m-auto text-center max-w-fit'>
          Want to practice using Markdown to format your recipes?{" "}
          <a
            target='_blank'
            className='underline underline-offset-2 hover:text-slate-400'
            href={"https://gcmoony-reactmd.netlify.app/"}
          >
            Check out my preview site here
          </a>
          !
        </div>
        ...
        <div className='flex justify-between mb-10'>
          <Link
            to={prevPage}
            className='rounded bg-slate-600 hover:bg-slate-500 p-2 leading-tight'
          >
            Cancel
          </Link>
          <button
            type='submit'
            className='rounded bg-blue-600 hover:bg-blue-500 p-2 leading-tight'
          >
            {formType} Recipe
          </button>
        </div>
